...
@Constraint(
    ...
    level = "Warning",
    location = "(base)",
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/research-study-prim-purp-type",
...
@Constraint(
    ...
    description = "SHOULD at least contain a code from value set http://hl7.org/fhir/ValueSet/research-study-objective-type",
