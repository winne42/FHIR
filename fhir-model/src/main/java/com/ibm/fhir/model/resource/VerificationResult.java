...
@Constraint(
    ...
    level = "Warning",
    location = "(base)",
    description = "SHOULD at least contain a code from value set http://hl7.org/fhir/ValueSet/verificationresult-need",
...
@Constraint(
    ...
    level = "Warning",
    location = "(base)",
    description = "SHOULD at least contain a code from value set http://hl7.org/fhir/ValueSet/verificationresult-validation-type",
...
@Constraint(
    ...
    level = "Warning",
    location = "(base)",
    description = "SHOULD at least contain a code from value set http://hl7.org/fhir/ValueSet/verificationresult-failure-action",
...
@Constraint(
    ...
    description = "SHOULD at least contain a code from value set http://hl7.org/fhir/ValueSet/verificationresult-validation-status",
...
@Constraint(
    ...
    description = "SHOULD at least contain a code from value set http://hl7.org/fhir/ValueSet/verificationresult-can-push-updates",
...
@Constraint(
    ...
    description = "SHOULD at least contain a code from value set http://hl7.org/fhir/ValueSet/verificationresult-push-type-available",
