...
@Constraint(
    ...
    level = "Warning",
    location = "(base)",
    description = "SHOULD at least contain a code from value set http://terminology.hl7.org/ValueSet/v2-0116",
...
@Constraint(
    ...
    level = "Warning",
    location = "(base)",
    description = "SHALL, if possible, at least contain a code from value set http://terminology.hl7.org/ValueSet/v3-ServiceDeliveryLocationRoleType",
