...
@Constraint(
    ...
    description = "SHALL, if possible, at least contain a code from value set http://terminology.hl7.org/ValueSet/v2-0916",
    expression = "$this.memberOf('http://terminology.hl7.org/ValueSet/v2-0916', 'extensible')"
)
@Constraint(
    id = "specimen-1",
    level = "Warning",
    location = "(base)",
    description = "SHALL, if possible, at least contain a code from value set http://terminology.hl7.org/ValueSet/v2-0493",
