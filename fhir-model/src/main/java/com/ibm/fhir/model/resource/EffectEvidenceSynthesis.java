...
@Constraint(
    ...
    level = "Warning",
    location = "(base)",
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/synthesis-type",
...
@Constraint(
    ...
    level = "Warning",
    location = "(base)",
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/study-type",
...
@Constraint(
    ...
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/evidence-variant-state",
...
@Constraint(
    ...
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/effect-estimate-type",
...
@Constraint(
    ...
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/precision-estimate-type",
...
@Constraint(
    ...
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/evidence-quality",
...
@Constraint(
    ...
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/certainty-subcomponent-type",
...
@Constraint(
    ...
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/certainty-subcomponent-rating",
