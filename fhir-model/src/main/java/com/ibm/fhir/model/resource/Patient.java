...
@Constraint(
    ...
    level = "Warning",
    location = "(base)",
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/marital-status",
...
@Constraint(
    ...
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/patient-contactrelationship",
...
@Constraint(
    ...
    description = "SHOULD at least contain a code from value set http://hl7.org/fhir/ValueSet/languages",
