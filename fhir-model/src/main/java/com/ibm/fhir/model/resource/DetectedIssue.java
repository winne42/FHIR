...
@Constraint(
    ...
    level = "Warning",
    location = "(base)",
    description = "SHOULD at least contain a code from value set http://hl7.org/fhir/ValueSet/detectedissue-category",
...
@Constraint(
    ...
    description = "SHOULD at least contain a code from value set http://hl7.org/fhir/ValueSet/detectedissue-mitigation-action",
