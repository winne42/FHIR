...
@Constraint(
    ...
    level = "Warning",
    location = "(base)",
    description = "SHOULD at least contain a code from value set http://hl7.org/fhir/ValueSet/observation-category",
...
@Constraint(
    ...
    level = "Warning",
    location = "(base)",
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/data-absent-reason",
...
@Constraint(
    ...
    level = "Warning",
    location = "(base)",
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/observation-interpretation",
...
@Constraint(
    ...
    description = "SHOULD at least contain a code from value set http://hl7.org/fhir/ValueSet/referencerange-meaning",
