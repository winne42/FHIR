...
@Constraint(
    ...
    level = "Warning",
    location = "(base)",
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/audit-event-type",
...
@Constraint(
    ...
    level = "Warning",
    location = "(base)",
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/audit-event-sub-type",
...
@Constraint(
    ...
    level = "Warning",
    location = "(base)",
    description = "SHALL, if possible, at least contain a code from value set http://terminology.hl7.org/ValueSet/v3-PurposeOfUse",
...
@Constraint(
    ...
    level = "Warning",
    location = "agent.type",
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/participation-role-type",
...
@Constraint(
    ...
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/dicm-405-mediatype",
...
@Constraint(
    ...
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/audit-source-type",
...
@Constraint(
    ...
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/audit-entity-type",
...
@Constraint(
    ...
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/object-role",
...
@Constraint(
    ...
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/object-lifecycle-events",
...
@Constraint(
    ...
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/security-labels",
