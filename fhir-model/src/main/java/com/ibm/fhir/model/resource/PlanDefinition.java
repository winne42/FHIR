...
@Constraint(
    ...
    level = "Warning",
    location = "(base)",
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/plan-definition-type",
...
@Constraint(
    ...
    description = "SHOULD at least contain a code from value set http://hl7.org/fhir/ValueSet/goal-priority",
...
@Constraint(
    ...
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/subject-type",
    expression = "$this.memberOf('http://hl7.org/fhir/ValueSet/subject-type', 'extensible')"
)
@Constraint(
    id = "planDefinition-6",
    level = "Warning",
    location = "action.type",
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/action-type",
