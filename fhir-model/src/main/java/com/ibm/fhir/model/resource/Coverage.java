...
@Constraint(
    ...
    level = "Warning",
    location = "(base)",
    description = "SHOULD at least contain a code from value set http://hl7.org/fhir/ValueSet/coverage-type",
...
@Constraint(
    ...
    level = "Warning",
    location = "(base)",
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/subscriber-relationship",
...
@Constraint(
    ...
    level = "Warning",
    location = "class.type",
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/coverage-class",
...
@Constraint(
    ...
    description = "SHALL, if possible, at least contain a code from value set http://hl7.org/fhir/ValueSet/coverage-copay-type",
